...
Нажмите ENTER для продолжения";
        ...
        static List<Player> createPlayers(int len)
        {
        ...
        static void ChooseCombination(Player x)
        {
            bool ok;
            int choise;
        ...
        static void Results(List<Player> players)
        {
            int max = 0;
        ...
        static void ChacngeCombinations(Player x)
        {
            int trys = 3;
            int tek = 0;
            while (tek < trys)
